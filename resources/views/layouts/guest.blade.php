...
<head>
    ...
    <!-- Scripts -->
    <link rel="preload" as="style" href="public/build/assets/app-CCdc4LY-.css" public="" build="" assets="">
    <link rel="modulepreload" href="public/build/assets/app-ZDKuOaA1.js">
    <link rel="stylesheet" href="public/build/assets/app-CCdc4LY-.css">
...
<body class="font-sans text-gray-900 antialiased">
    <div class="min-h-screen relative flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-white">
        <div>
            <a href="/" class="text-2xl font-bold uppercase text-rose-500">
                {{ config('app.name', 'Valmula') }}
            </a>
        </div>
        ...
        <div class="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div class="container bg-white py-2 px-4 rounded-md shadow-md">
                {{ $slot }}
            </div>
        </div>
